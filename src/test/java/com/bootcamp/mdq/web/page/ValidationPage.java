...
public class ValidationPage extends WebPage {
    ...
    @FindBy(css = ".cko-field.cc-expiry-month.fast-payment-include.gb-whitelist")
    private WebElement expirationDateMonthSelect;

    @FindBy(css = ".cko-field.cc-expiry-year.fast-payment-include.gb-whitelist")
    private WebElement expirationDateYearSelect;

    @FindBy(id = "new_cc_security_code")
    private WebElement securityCodeInput;

    @FindBy(css = ".text.cko-field.fast-payment-include.pwp-insurance-zipcode")
